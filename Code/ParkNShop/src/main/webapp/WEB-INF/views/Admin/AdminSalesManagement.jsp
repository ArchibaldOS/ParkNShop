                    ...
                    <div class="col-md-8">
                        <form action="#">
                            <div class="panel-body" id="select_time_div">
                                ...
                                <input type="date" name="time" id="time_select" hidden>
        ...
        datasets : [
            {
                ...
                data : [${counts[0]}, ${counts[1]},${counts[2]},${counts[3]},${counts[4]},${counts[5]}]
            }
        ]
    };
        ...
        datasets : [
            {
                ...
                data : [${moneys[0]}, ${moneys[1]}, ${moneys[2]},${moneys[3]},${moneys[4]},${moneys[5]}]
            }
        ]
    };
