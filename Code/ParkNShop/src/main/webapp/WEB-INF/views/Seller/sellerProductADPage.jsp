        ...
        <div class="row">
            <div class="col-md-2" style="margin-top:9%">
                <div class="list-group">
                     <a href="/sellerADPage" class="list-group-item">Shop Ad</a>
                    <a href="/sellerProductADPage" class="list-group-item  active">Product Ad</a>
                </div>
            </div>
            <div class="col-md-10">
                <div class="page-header">
                    <h4>Product Advertising History</h4>
                </div>
                <c:set var="ads" value="${requestScope.productAD }" />
                <table class="table">
                    <thead>
                    <tr>
                        <th>AD Id</th>
        ...
        <div class="page-header" style="width:60%;margin-left:200px;">
            ...
            <form class="form-horizontal" role="form" action="/sellerProductAD" method="post" enctype="multipart/form-data" name="formen">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<select id="disabledSelect" name="otherId" class="form-control" style="width:300px;">
					...
					<div class="form-group">
						<label for="disabledSelect" class="col-sm-5 control-label">AD Type</label>
						<div class="col-sm-3">
							<select id="disabledSelect" name="ADType" class="form-control" style="width:110px;">
								<option value="1">TOP10</option>
